...
async fn attack_handler(
    ...
    // --- CORRIGÉ : Création des objets CombatTechs ---
    let att_techs = game_logic::CombatTechs {
        laser: att_planet.laser_battery_level, // Utilise le niveau de laser comme tech offensive

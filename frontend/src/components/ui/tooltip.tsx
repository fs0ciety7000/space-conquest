    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          // Background & border - sci-fi style
          "bg-slate-900/95 border border-cyan-500/20",
          "backdrop-blur-xl",
          // Text
      ...
      >
        ...
        <TooltipPrimitive.Arrow 
          className="z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] fill-slate-900 border-r border-b border-cyan-500/20" 
        />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
